...
curl -v -X POST "http://localhost:8081/VerifyCert" -H 'content-type: application/json' -d '{"CertNo":"TEST20220413_01","LocalChainID":"1", "PersonInfoHash":"047d1be86e0ed70abfd55540a1d6fe09c91c74eb99f82d4f77926b721a87b0fe"}'
